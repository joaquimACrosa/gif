...
<head>
  <meta charset="UTF-8">
  <title>Dropship Bundles - GIF Design Studios</title>
...
<body class="single-portfolio no-hijack project-dropship-bundles">
<?php echo getHeader(); ?>
<div id="wrapper">
  <main id="portfolio-page">
    <div>
      <!--PROJECT HEADER-->
      <div id="single-project-cover" class="project_33 desktop">
        ...
        <div class="col col-12 hide-on-desktop"><img src="../img/GIF-DropshipBundles-01.jpg" alt="DropshipBundles" class="full-width"></div>
      </div>
      <!--END PROJECT HEADER-->
      ...
      <div class="col col-12" ><img src="../img/GIF-DropshipBundles-02.jpg" alt="DropshipBundles" class="full-width"></div>
      ...
      <div class="col col-12" ><img src="../img/GIF-DropshipBundles-04.jpg" alt="DropshipBundles" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-DropshipBundles-05.jpg" alt="DropshipBundles" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-DropshipBundles-06.jpg" alt="DropshipBundles" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-DropshipBundles-07.jpg" alt="DropshipBundles" class="full-width"></div>
