...
<head>
  <meta charset="UTF-8">
  <title>Shaggy Supps - GIF Design Studios</title>
...
<body class="single-portfolio no-hijack project-shaggy-supps">
<? echo getHeader(); ?>
<div id="wrapper">
  <main id="portfolio-page">
    <div>
      <!--PROJECT HEADER-->
      <div id="single-project-cover" class="project_34 desktop">
        ...
        <div class="col col-12 hide-on-desktop"><img src="../img/GIF-ShaggySupps-01.jpg" alt="ShaggySupps" class="full-width"></div>
      </div>
      <!--END PROJECT HEADER-->
      ...
      <div class="portfolio-info-container" id="anchor">
        ...
        <div class="project-nav">
          <div class="nav-prev">
              <a href="bob-heilig.php"><img width="43" src="../img/GIF-ArrowLeft-Grey-@2x.png" alt="Left"></a>
              <div>Previous</div>
          </div>
          <div class="nav-next">
      ...
      <div class="col col-12" ><img src="../img/GIF-ShaggySupps-02.jpg" alt="ShaggySupps" class="full-width"></div>
      ...
      <div class="col col-12" ><img src="../img/GIF-ShaggySupps-04.jpg" alt="ShaggySupps" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-ShaggySupps-05.jpg" alt="ShaggySupps" class="full-width"></div>
      ...
      <div class="footer-project-nav project-nav">
        <div class="nav-prev"><a href="bob-heilig.php"><img class="white-arrow hide-on-mobile" width="43" src="../img/GIF-ArrowLeft-White-@2x.png" alt="Left"><img class="grey-arrow mobile" width="43" src="../img/GIF-ArrowLeft-Grey-@2x.png" alt="Left"><div>Previous</div></a></div>
