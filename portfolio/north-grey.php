...
<head>
  <meta charset="UTF-8">
  <title>North of Grey - GIF Design Studios</title>
...
<body class="single-portfolio no-hijack project-north-grey">
<?php echo getHeader(); ?>
<div id="wrapper">
  <main id="portfolio-page">
    <div>
      <!--PROJECT HEADER-->
      <div id="single-project-cover" class="project_22 desktop">
      ...
      <div class="portfolio-info-container" id="anchor">
        <div class="single-portfolio-info">
          ...
          <div class="portfolio-details col-3">
            ...
            <p class="text">Caroline Groeneveld</p>
      ...
      <div class="col col-12" ><img src="../img/GIF-NorthOfGrey-02.jpg" alt="NorthOfGrey" class="full-width"></div>
      <div class="cell col-6 table testimonial">
        <div class="square-responsive square-center">
            ...
            <p class="bold project-text-color">Caroline Groeneveld</p>
        </div>
      </div>
      <div class="cell col-6 desktop" >
        <div class="square-responsive square-image1"></div>
      </div>
      <div class="col col-12" ><img src="../img/GIF-NorthOfGrey-04.jpg" alt="NorthOfGrey" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-NorthOfGrey-05.jpg" alt="NorthOfGrey" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-NorthOfGrey-06.jpg" alt="NorthOfGrey" class="full-width"></div>
