    ...
    <div>
      ...
      <div class="portfolio-info-container" id="anchor">
        ...
        <div class="project-nav">
          <div class="nav-prev">
              <a href="peter-shankman.php"><img width="43" src="../img/GIF-ArrowLeft-Grey-@2x.png" alt="Left"></a>
              <div>Previous</div>
          </div>
          <div class="nav-next">
      ...
      <div class="footer-project-nav project-nav">
        <div class="nav-prev"><a href="peter-shankman.php"><img class="white-arrow hide-on-mobile" width="43" src="../img/GIF-ArrowLeft-White-@2x.png" alt="Left"><img class="grey-arrow mobile" width="43" src="../img/GIF-ArrowLeft-Grey-@2x.png" alt="Left"><div>Previous</div></a></div>
