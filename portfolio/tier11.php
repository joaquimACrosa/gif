...
<head>
  <meta charset="UTF-8">
  <title>Tier 11 - GIF Design Studios</title>
...
<div id="wrapper">
  <main id="portfolio-page">
    <div>
      <!--PROJECT HEADER-->
      <div id="single-project-cover" class="project_16 desktop">
      ...
      <div class="col col-12 hide-on-desktop"><img src="../img/GIF-Tier11-01.jpg" alt="Tier11" class="full-width"></div>
      <!--END PROJECT HEADER-->
      ...
      <div class="portfolio-info-container" id="anchor">
        ...
        <div class="project-nav">
          <div class="nav-prev">
              <a href="shaggy-supps.php"><img width="43" src="../img/GIF-ArrowLeft-Grey-@2x.png" alt="Left"></a>
              <div>Previous</div>
          </div>
          <div class="nav-next">
              <a href="taki-moore.php"><img width="43" src="../img/GIF-ArrowRight-Grey-@2x.png" alt="Right"></a>
      ...
      <div class="cell col-6 table testimonial">
        <div class="square-responsive square-center">
            ...
            <p class="bold project-text-color">Ralph Burns</p>
        </div>
      </div>
      ...
      <div class="footer-project-nav project-nav">
        <div class="nav-prev"><a href="shaggy-supps.php"><img class="white-arrow hide-on-mobile" width="43" src="../img/GIF-ArrowLeft-White-@2x.png" alt="Left"><img class="grey-arrow mobile" width="43" src="../img/GIF-ArrowLeft-Grey-@2x.png" alt="Left"><div>Previous</div></a></div>
        <div class="nav-next"><a href="taki-moore.php"><img class="white-arrow hide-on-mobile" width="43" src="../img/GIF-ArrowRight-White-@2x.png" alt="Right"><img width="43" class="grey-arrow mobile" src="../img/GIF-ArrowRight-Grey-@2x.png" alt="Left"><div>Next</div></a></div>
      </div>
      <? echo getFooter(); ?>
      <!--END FOOTER-->
