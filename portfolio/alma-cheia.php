...
<head>
  <meta charset="UTF-8">
  <title>Alma Cheia - GIF Design Studios</title>
...
<body class="single-portfolio no-hijack project-alma-cheia">
<?php echo getHeader(); ?>
<div id="wrapper">
  <main id="portfolio-page">
    <div>
      <!--PROJECT HEADER-->
      <div id="single-project-cover" class="project_21 desktop">
      ...
      <div class="col col-12 hide-on-desktop"><img src="../img/GIF-AlmaCheia-01.jpg" alt="AlmaCheia" class="full-width"></div>
      <!--END PROJECT HEADER-->
      ...
      <div class="portfolio-info-container" id="anchor">
        <div class="single-portfolio-info">
          ...
          <div class="portfolio-details col-3">
            ...
            <p class="text">Maria Sacchetti</p>
        ...
        <div class="project-nav">
          <div class="nav-prev">
              <a href="naturally-made-essentials.php"><img width="43" src="../img/GIF-ArrowLeft-Grey-@2x.png" alt="Left"></a>
              <div>Previous</div>
          </div>
          <div class="nav-next">
      ...
      <div class="col col-12" ><img src="../img/GIF-AlmaCheia-02.jpg" alt="AlmaCheia" class="full-width"></div>
      <div class="cell col-6 table testimonial">
        <div class="square-responsive square-center">
            ...
            <p class="bold project-text-color">Maria Sacchetti</p>
        </div>
      </div>
      <div class="cell col-6 desktop" >
        <div class="square-responsive square-image1"></div>
      </div>
      <div class="col col-12" ><img src="../img/GIF-AlmaCheia-04.jpg" alt="AlmaCheia" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-AlmaCheia-05.jpg" alt="AlmaCheia" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-AlmaCheia-06.jpg" alt="AlmaCheia" class="full-width"></div>
