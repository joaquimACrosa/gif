...
<head>
  <meta charset="UTF-8">
  <title>Flyt Buddy - GIF Design Studios</title>
...
<div id="wrapper">
  <main id="portfolio-page">
    <div>
      <!--PROJECT HEADER-->
      <div id="single-project-cover" class="project_32 desktop">
        ...
        <div class="col col-12 hide-on-desktop"><img src="../img/GIF-FlytBuddy-01.jpg" alt="FlytBuddy" class="full-width"></div>
      </div>
      <!--END PROJECT HEADER-->
      ...
      <div class="col col-12" ><img src="../img/GIF-FlytBuddy-02.jpg" alt="FlytBuddy" class="full-width"></div>
      ...
      <div class="col col-12" ><img src="../img/GIF-FlytBuddy-03.jpg" alt="FlytBuddy" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-FlytBuddy-04.jpg" alt="FlytBuddy" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-FlytBuddy-05.jpg" alt="FlytBuddy" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-FlytBuddy-06.jpg" alt="FlytBuddy" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-FlytBuddy-07.jpg" alt="FlytBuddy" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-FlytBuddy-08.jpg" alt="FlytBuddy" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-FlytBuddy-09.jpg" alt="FlytBuddy" class="full-width"></div>
