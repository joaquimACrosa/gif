...
<head>
  <meta charset="UTF-8">
  <title>Kula - GIF Design Studios</title>
...
<body class="single-portfolio no-hijack project-kula">
<?php echo getHeader(); ?>
<div id="wrapper">
  <main id="portfolio-page">
    <div>
      <!--PROJECT HEADER-->
      <div id="single-project-cover" class="project_18 desktop">
      ...
      <div class="col col-12 hide-on-desktop"><img src="../img/GIF-Kula-01.jpg" alt="Kula" class="full-width"></div>
      <!--END PROJECT HEADER-->
      ...
      <div class="col col-12" ><img src="../img/GIF-Kula-02.jpg" alt="Kula" class="full-width"></div>
      <div class="cell col-6 table testimonial">
        <div class="square-responsive square-center">
            ...
            <p class="bold project-text-color">Kylah Dobson</p>
        </div>
      </div>
      <div class="cell col-6 desktop" >
        <div class="square-responsive square-image1"></div>
      </div>
      <div class="col col-12" ><img src="../img/GIF-Kula-04.jpg" alt="Kula" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-Kula-05.jpg" alt="Kula" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-Kula-06.jpg" alt="Kula" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-Kula-07.jpg" alt="Kula" class="full-width"></div>
      ...
      <div class="project-links project-color">
        ...
        <!-- <div class="col col-3">
          <div class="link-icon"><a target="_blank" class="white" href=""><i class="fa fa-link active" aria-hidden="true"></i></a></div>
          <div class="link-text hide-on-mobile"><a target="_blank" class="white" href=""></a></div>
          <div class="link-text mobile"><a target="_blank" class="white" href="http://">Website</a></div>
        </div> -->
        <div class="col col-3"></div>
      </div>
