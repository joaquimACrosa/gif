...
<head>
  <meta charset="UTF-8">
  <title>Meal - GIF Design Studios</title>
...
<body class="single-portfolio no-hijack project-meal">
<? echo getHeader(); ?>
<div id="wrapper">
  <main id="portfolio-page">
    <div>
      <!--PROJECT HEADER-->
      <div id="single-project-cover" class="project_23 desktop">
      ...
      <div class="col col-12 hide-on-desktop"><img src="../img/GIF-Meal-01.jpg" alt="Meal" class="full-width"></div>
      <!--END PROJECT HEADER-->
      ...
      <div class="portfolio-info-container" id="anchor">
        <div class="single-portfolio-info">
          ...
          <div class="portfolio-details col-3">
            ...
            <p class="text">Mitchel Van Duuren</p>
        ...
        <div class="project-nav">
          ...
          <div class="nav-next">
              <a href="nutrition-therapy-institute.php"><img width="43" src="../img/GIF-ArrowRight-Grey-@2x.png" alt="Right"></a>
      ...
      <div class="col col-12" ><img src="../img/GIF-Meal-02.jpg" alt="Meal" class="full-width"></div>
      <div class="cell col-6 table testimonial">
        <div class="square-responsive square-center">
            ...
            <p class="bold project-text-color">Mitchel Van Duuren</p>
        </div>
      </div>
      <div class="cell col-6 desktop" >
        <div class="square-responsive square-image1"></div>
      </div>
      <div class="col col-12" ><img src="../img/GIF-Meal-04.jpg" alt="Meal" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-Meal-05.jpg" alt="Meal" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-Meal-06.jpg" alt="Meal" class="full-width"></div>
      ...
      <div class="footer-project-nav project-nav">
        ...
        <div class="nav-next"><a href="nutrition-therapy-institute"><img class="white-arrow hide-on-mobile" width="43" src="../img/GIF-ArrowRight-White-@2x.png" alt="Right"><img width="43" class="grey-arrow mobile" src="../img/GIF-ArrowRight-Grey-@2x.png" alt="Left"><div>Next</div></a></div>
      </div>
      <? echo getFooter(); ?>
      <!--END FOOTER-->
