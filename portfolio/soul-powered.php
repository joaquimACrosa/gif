...
<head>
  <meta charset="UTF-8">
  <title>Soul Powered - GIF Design Studios</title>
...
<body class="single-portfolio no-hijack project-soul-powered">
<?php echo getHeader(); ?>
<div id="wrapper">
  <main id="portfolio-page">
    <div>
      <!--PROJECT HEADER-->
      <div id="single-project-cover" class="project_28 desktop">
      ...
      <div class="col col-12 hide-on-desktop"><img src="../img/GIF-SoulPowered-01.jpg" alt="SoulPowered" class="full-width"></div>
      <!--END PROJECT HEADER-->
      ...
      <div class="portfolio-info-container" id="anchor">
        <div class="single-portfolio-info">
          ...
          <div class="portfolio-details col-3">
            ...
            <p class="text">Brenda Wilkins & Sara Kaler</p>
      ...
      <div class="col col-12" ><img src="../img/GIF-SoulPowered-02.jpg" alt="SoulPowered" class="full-width"></div>
      <div class="cell col-6 table testimonial">
        <div class="square-responsive square-center">
            ...
            <p class="bold project-text-color">Brenda Wilkins & Sara Kaler</p>
        </div>
      </div>
      <div class="cell col-6 desktop" >
        <div class="square-responsive square-image1"></div>
      </div>
      <div class="col col-12" ><img src="../img/GIF-SoulPowered-04.jpg" alt="SoulPowered" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-SoulPowered-05.jpg" alt="SoulPowered" class="full-width"></div>
      <div class="col col-12" ><img src="../img/GIF-SoulPowered-06.jpg" alt="SoulPowered" class="full-width"></div>
