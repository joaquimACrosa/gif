      ...
      <section class="team-section">
          ...
          <div class="container">
            <div class="row">
                ...
                <div class="team-member-container">
                    <div class="image-container maria">
                        <div class="team-overlay" style="display: none;"></div>
                    </div>
                    <div class="name">Maria Soares</div>
                    <div class="job">Project Manager</div>
                </div>
                <div class="team-member-container">
                    <div class="image-container joaquim">
                        <div class="team-overlay" style="display: none;"></div>
                    </div>
                    <div class="name">Joaquim Rosa</div>
                    <div class="job">Web Developer</div>
                </div>
                <div class="team-member-container">
                    <div class="image-container paulo">
                        <div class="team-overlay" style="display: none;"></div>
                    </div>
                ...
                <div class="team-member-container new">
                    <div class="image-container"><div class="new-inner">Want to be our next <br/>Web Developer?</div></div>
                    <div class="name"><a class="btn btn-orange animate" href="/hire-us">Let's Dev!</a></div>

                </div>
                <div class="team-member-container new">
                    <div class="image-container new"><div class="new-inner">Want to be our next <br/>UI/UX Designer?</div></div>
